          ...
          <div class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <option value="1" selected="selected">One Month(₹300)</option>
                  <option value="3">Three Month(₹800)</option>
                  <option value="6">Six Month(₹1200)</option>
                  <option value="12">One Year(₹2000)</option>
                </select>
              </div>
          ...
          <div class="control-group">
              ...
              <div class="controls">
                ...
                <label>
                  ...
                  Sauna <small>- ₹1000 per month</small></label>
                <label>
                  <input type="radio" value="Cardio" name="services" />
                  Cardio <small>- ₹750 per month</small></label>
              </div>
            </div>
