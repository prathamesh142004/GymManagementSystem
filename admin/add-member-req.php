...
<div id="content">
    ...
    <form role="form" action="index.php" method="POST">
        ...
        if(isset($_POST['fullname'])){
            ...
            $qry = "INSERT INTO members(fullname, username, password, dor, gender, services, amount, p_year, paid_date, plan, address, contact) VALUES ('$fullname', '$username', '$hashed_password', '$dor', '$gender', '$services', '$totalamount', '$p_year', '$paid_date', '$plan', '$address', '$contact')";
            $result = mysqli_query($conn, $qry); // Execute SQL query
